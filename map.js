// Import D3 as an ESM (ES module)
import * as d3 from 'https://cdn.jsdelivr.net/npm/d3@7.9.0/+esm';
// Import Mapbox as an ESM (ES module)
...
const map = new mapboxgl.Map({
  ...
  // Map styles at https://docs.mapbox.com/api/maps/styles/
  // style: 'mapbox://styles/mapbox/streets-v12',
  style: 'mapbox://styles/mapbox/light-v11',
  center: [-71.09415, 42.36027], // [longitude, latitude]
  zoom: 11.75, // Initial zoom level
  minZoom: 5, // Minimum allowed zoom
  maxZoom: 18, // Maximum allowed zoom
});


// Create a helper function, getCoords(), that takes in a station object and 
...
// Wait for the "load" event to fire on map to make sure the map is fully loaded before fetching and displaying the data:
map.on('load', async () => {
  ...
  // To actually see something, we need to actually use the data to draw something on the map.
  map.addLayer({
  ...
  const tripsCSVurl = 'https://dsc106.com/labs/lab07/data/bluebikes-traffic-2024-03.csv';
  // Await traffic data
  ...
  // ensure the map is fully loaded before fetching and displaying the station data
  ...
  // To ensure the station markers stay aligned when the map pans, zooms, or resizes,
  // define an updatePositions() function to reposition the circles whenever the map changes. 
